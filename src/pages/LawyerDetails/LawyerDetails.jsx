...
const LawyerDetails = () => {
  ...
  <div className="card-body">
    ...
    <div className='flex max-w-[250px] items-center gap-3 mt-3'>
    <p> <span className='font-bold'>Availability</span>  </p>

    {
        singleLawyer.availability.map((day) => 
           (
             <button className=" btn-xs btn-softs bg-[#FFA0001A] text-[#FFA000]  font-light  mr-2 rounded-full py-1 px-3 ">{day}</button>
           )
        )
    }

    </div>
    <p className='font-bold mt-3'>Consultation Fee: <span className='text-[#0EA106]'>{singleLawyer.fee}</span> </p>
  ...
  <hr className='border-1 border-dashed text-gray-400 mt-2 '></hr>
   ...
   <button className="btn btn-xs btn-soft bg-[#0EA106] text-white  text-base  mt-4 mx-20 rounded-full p-5 ">
